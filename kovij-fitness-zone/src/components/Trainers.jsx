...
function Trainers() {
  ...
  return (
    <section id="trainers" className="overflow-x-hidden bg-[#131313] pb-20 pt-12 text-[#e5e2e1]">
      <header className="mx-auto mb-10 max-w-7xl px-6">
        <div className="flex flex-col gap-6 border-l-4 border-[#d32f2f] py-4 pl-6 md:flex-row md:items-end md:justify-between">
          <div>
            <span className="mb-2 block text-xs font-bold uppercase tracking-[0.2em] text-[#ffb786]">The Elite Squad</span>
            <h2 className="font-['Lexend'] text-5xl font-black uppercase italic leading-none text-white md:text-6xl">
      ...
      {loading ? (
        <div className="mx-auto max-w-7xl px-6 py-16 text-center text-neutral-500">Loading trainers…</div>
      ) : trainers.length === 0 ? (
        <div className="mx-auto max-w-7xl px-6 py-16 text-center text-neutral-500">No trainers available right now.</div>
      ) : (
        <section className="mx-auto grid max-w-7xl grid-cols-1 gap-4 px-6 md:grid-cols-2 lg:grid-cols-12">
          {featured[0] && (
            <motion.article
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="group relative flex min-h-[500px] flex-col justify-end overflow-hidden border border-neutral-800 bg-[#201f1f] lg:col-span-7"
            >
              <img
              ...
              <div className="relative mb-6 ml-6 max-w-lg border-l-4 border-[#d32f2f] bg-[#131313]/80 p-6 backdrop-blur-sm">
                ...
                <h3 className="font-['Lexend'] text-3xl font-black uppercase italic text-white">{featured[0].name}</h3>
                ...
                <div className="flex flex-wrap items-center gap-6">
                  <div>
                    ...
                    <p className="font-['Lexend'] text-xl font-bold text-white">Certified</p>
                  </div>
                  <div>
                    <span className="text-[10px] font-bold uppercase text-[#d32f2f]">Focus</span>
                    <p className="font-['Lexend'] text-xl font-bold text-white">{featured[0].role}</p>
                  </div>
                  <a
      ...
      <section className="mx-auto mt-16 max-w-7xl px-6">
        <div className="relative grid items-center gap-10 overflow-hidden border border-neutral-800 bg-[#1c1b1b] p-10 lg:grid-cols-2">
          <div className="pointer-events-none absolute right-0 top-0 h-64 w-64 rounded-full bg-[#d32f2f]/10 blur-[100px]" />
          <div>
            <span className="mb-4 block text-xs font-bold uppercase tracking-[0.3em] text-[#d32f2f]">The Kovij Standard</span>
            <h3 className="mb-6 font-['Lexend'] text-3xl font-black uppercase leading-tight text-white md:text-4xl">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-start gap-4">
                <FaCheckCircle className="mt-0.5 text-2xl text-[#ffb786]" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <FaChartLine className="mt-0.5 text-2xl text-[#d32f2f]" />
                <div>
          ...
          <div className="relative">
            <div className="corner-cut-tr group relative flex aspect-video items-center justify-center overflow-hidden border-2 border-neutral-800 bg-neutral-900">
              ...
              <button
                type="button"
                className="relative flex h-16 w-16 items-center justify-center rounded-full bg-[#d32f2f] text-white shadow-lg shadow-[#d32f2f]/30 transition hover:scale-110"
      ...
      <section className="mx-auto mt-12 max-w-7xl px-6">
        <div className="corner-cut-bl relative flex flex-col items-center justify-between gap-8 overflow-hidden bg-[#d32f2f] p-10 md:flex-row md:p-12">
          ...
          <div className="relative z-10 text-center md:text-left">
            <h3 className="mb-2 font-['Lexend'] text-4xl font-black uppercase italic text-white md:text-5xl">
              Find Your <span className="text-black not-italic">Lead</span>
            </h3>
            <p className="text-lg text-white/80">Not sure which trainer fits your mission? Let us match you.</p>
          </div>
          <div className="relative z-10 flex w-full flex-col gap-4 md:w-auto md:flex-row">
            <a
              href="#contact"
              className="corner-cut-tr flex-1 bg-black px-8 py-4 text-center font-['Lexend'] text-sm font-black uppercase tracking-widest text-white transition hover:bg-neutral-900 md:flex-none"
            >
              Book Consult
            </a>
            <a
              href="#contact"
              className="flex-1 border-2 border-white px-8 py-4 text-center font-['Lexend'] text-sm font-black uppercase tracking-widest text-white transition hover:bg-white hover:text-[#d32f2f] md:flex-none"
            >
              Take the Quiz
            </a>
          </div>
